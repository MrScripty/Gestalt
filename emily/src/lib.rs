...
pub use model::{
    AppendAuditRecordRequest, AppendSovereignAuditRecordRequest, AuditRecord, AuditRecordKind,
    ContextItem, ContextPacket, ContextQuery, CreateEpisodeRequest, DatabaseLocator, EarlDecision,
    EarlEvaluationRecord, EarlEvaluationRequest, EarlHostAction, EarlSignalVector,
    EmbeddingProviderStatus, EpisodeRecord, EpisodeState, EpisodeTraceKind, EpisodeTraceLink,
