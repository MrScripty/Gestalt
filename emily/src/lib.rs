...
pub use model::{
    ...
    OutcomeRecord, OutcomeStatus, RecordOutcomeRequest, RemoteEpisodeRecord, RemoteEpisodeRequest,
    RemoteEpisodeState, RoutingDecision, RoutingDecisionKind, RoutingTarget,
    SovereignAuditMetadata, TextEdge, TextEdgeType, TextObject, TextObjectKind, TextVector,
    TraceLinkRequest, ValidationDecision, ValidationFinding, ValidationFindingSeverity,
    ValidationOutcome, VectorizationConfig, VectorizationConfigPatch, VectorizationJobKind,
